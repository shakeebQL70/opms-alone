...
import { exportDCVisitorDetails } from '../helper';
...
const List = ({handleOpen}: IList) => {
  ...
  const {isLoading, getList, list, getAll, allList, allLoading, openEditModal} = dcVisitorStore
  ...
  const exported = useMemo(() => {
    const toExport = exportDCVisitorDetails(allList)
  ...
  return (
    <Box>
        <ExportTableButton data={exported} filename="DC Details" text="Export DC Details" />
        <TableWrapper>
            <TableHeadWrapper>
                ...
                <StyledTableCell>Visitor Type</StyledTableCell>
                <StyledTableCell
                ...
                list?.results?.map((item: any, index: number) => {
                  ...
                  return (
                    <StyledTableRow key={index}>
                        ...
                        <StyledTableCell>{formatDateYYYYMMDD(item.date_of_visit)}</StyledTableCell>
                        <StyledTableCell>{item.visit_type}</StyledTableCell>
