...
import { exportLabAssetReplacement } from "./helper";
...
const List = ({ handleOpen }: IList) => {
  ...
  const exported = useMemo(() => {
    const toExport = exportLabAssetReplacement(allList)
  ...
  return (
    <Box>
      <ExportTableButton
        data={exported}
        filename="Asset Request List"
        text="Export Asset Request List"
      />
      <TableWrapper>
        <TableHeadWrapper>
                ...
                list?.results?.map((item: any, index: number) => {
                  ...
                  return (
                    <StyledTableRow key={index}>
                        ...
                        <StyledTableCell>{item?.assetItemMake}</StyledTableCell>
                        <StyledTableCell>{item?.assetSerialNo}</StyledTableCell>
